...
function showNextImage() {
  ...
  // Remove the oldest image after 5 seconds
  setTimeout(() => {
...
function openDynamicContent() {
  const overlay = document.getElementById('overlay');
  const modalContent = document.getElementById('modalContent');
  const xhttp = new XMLHttpRequest();

  // Replace 'index.html' with the actual file or URL you want to load
  xhttp.open('GET', 'webdevteam.html', true);
